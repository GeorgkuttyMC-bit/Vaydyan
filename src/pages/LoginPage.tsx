  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-earth-50 px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-sm border border-earth-100 text-center">
        ...
        <h2 className="text-3xl font-serif text-earth-800 mb-2">Welcome Back</h2>
        <p className="text-earth-500 mb-8">Sign in to securely access your consultations and Ayurvedic remedies.</p>
        
        <button 
          onClick={signInWithGoogle}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white border border-earth-300 text-earth-700 px-6 py-4 rounded-md font-medium hover:bg-earth-50 transition-colors shadow-sm disabled:opacity-50"
        >
